...
(function () {
  ...
  window.tourCard = function (t, lang) {
    ...
    return `<a class="card" href="${BASE}detail.html?id=${t.id}" target="_blank" rel="noopener">
      ...
      <div class="body">
        ...
        <div class="card-cal">${ calHTML(t,{full:true}) }</div>
...
function calHTML(t, opts){
    ...
    const head = full ? '<div class="cal-head"><button type="button" class="cal-prev" onclick="if().calNav(this,-1)">‹</button><span class="cal-cur"></span><button type="button" class="cal-next" onclick="if().calNav(this,1)">›</button></div>' : '';
