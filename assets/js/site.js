        ...
        <div class="footer-grid">
          ...
          <div>
            ...
            <div class="contact-card-cyan">
              ...
              ${window.CONTACT.wechatOfficialQr?`<div style="margin:8px 0 2px"><img src="${window.CONTACT.wechatOfficialQr}" alt="${window.CONTACT.wechatOfficial} 公众号二维码" style="width:120px;height:120px;border-radius:8px;background:#fff;padding:4px;box-shadow:0 2px 8px rgba(0,0,0,.1)"></div>`:''}
            </div>
          </div>
          <div>
