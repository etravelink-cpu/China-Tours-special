      ...
      <div class="footer-inner">
        <div class="footer-grid">
          ...
          <div>
            ...
            <a href="javascript:void(0)" onclick="EtripsFloat.toggle('wx-pop','.float-btn.wechat')" title="微信客服"><img src="assets/img/wechat-icon.jpg" alt="微信" class="wx-ico"> 微信：${window.CONTACT.wechatName} ${window.CONTACT.wechat} / ${window.CONTACT.wechat2Name} ${window.CONTACT.wechat2}</a>
